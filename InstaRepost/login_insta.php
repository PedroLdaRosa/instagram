                    ...
                    <div class="col" class='caixa'>
                        ...
                        <div class="card" style="width: 348px; height: 400px;">
                            ...
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-floating  d-grid gap-2" style="width: 258px; height: 36px; font-size: 12px; margin-bottom: 30px; ">
                                ...
                                <div class="d-grid gap-2 botao">
                                    <button style="margin-left: 0px;" type="button" class="btn btn-primary">Entrar</button>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <div class="foto_face">
                                    ...
                                    <button type="button" class="face btn btn-link">Entrar com o Facebook</button>
                                    <div>
                                        <button type="button" class=" esqueceu btn btn-link">Esqueceu a Senha?</button>
                                    </div>
                                </div>
                                <div>
